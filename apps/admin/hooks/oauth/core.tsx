...
export const getCoreAuthenticationModesMap: (
  ...
  { disabled, updateConfig, resolvedTheme },
  t
) => ({
  "unique-codes": {
    key: "unique-codes",
    name: t("admin.oauth.unique_codes.name"),
    description: t("admin.oauth.unique_codes.description"),
  ...
  "passwords-login": {
    key: "passwords-login",
    name: t("admin.oauth.passwords.name"),
    description: t("admin.oauth.passwords.description"),
  ...
  google: {
    key: "google",
    name: "Google",
    description: t("admin.oauth.google.description"),
  ...
  github: {
    key: "github",
    name: "GitHub",
    description: t("admin.oauth.github.description"),
    icon: (
      <img
  ...
  gitlab: {
    key: "gitlab",
    name: "GitLab",
    description: t("admin.oauth.gitlab.description"),
  ...
  gitea: {
    key: "gitea",
    name: "Gitea",
    description: t("admin.oauth.gitea.description"),
